...
function custom_akcia_type() {
    $labels = array(
        ...
        'name_admin_bar'        => __( 'Акция', 'text_domain' ),
...
function custom_taxonomy() {
    $labels = array(
        'name'                       => _x( 'Категории для акций', 'Taxonomy General Name', 'text_domain' ),
        'singular_name'              => _x( 'Категория для акций', 'Taxonomy Singular Name', 'text_domain' ),
        'menu_name'                  => __( 'Категории для акций', 'text_domain' ),
        'all_items'                  => __( 'All Items', 'text_domain' ),
    ...
    register_taxonomy( 'category_akcia', array( 'akcia' ), $args );
}
