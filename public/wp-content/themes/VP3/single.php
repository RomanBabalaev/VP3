...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    <div class="content">
        ...
        <div class="article-pagination">
            <div class="article-pagination__block pagination-prev-left"><a href="<?php the_permalink($prev->ID)?>" class="article-pagination__link"><i class="icon icon-angle-double-left"></i>Предыдущая статья</a>
                <div class="wrap-pagination-preview pagination-prev-left">
                    <div class="preview-article__img"><img src="<?php get_the_post_thumbnail_url($prev->ID); ?>" class="preview-article__image"></div>
        ...
        <div class="sidebar__sidebar-item">
            ...
            <div class="sidebar-item__content">
                ...
                <!--<ul class="tags-list">
                    ...
                    <li class="tags-list__item"><a href="#" class="tags-list__item__link">рука</a></li>
